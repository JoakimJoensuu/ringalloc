 ...
 *
 * @return Address of reallocated block, suitably aligned for any object with
 *         fundamental alignment; might be a new one; bytes in @p allocation are
 *         preserved up to the smaller of @p size and the old size. nullptr if no room;
 *         @p allocation unchanged on failure.
 */
